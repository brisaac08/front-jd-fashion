...
export function EditMonturaModal({ product, onClose, onUpdated }: readonly Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-background p-6 rounded-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
